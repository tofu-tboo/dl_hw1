...
my_model = Model(my_layers, evaluate=SoftmaxCrossEntropy(), optimizer=SGD(lr=0.25, weight_decay=0.0))
pck_model = TorchNNModel(layers=pck_layers, evaluate=nn.CrossEntropyLoss(), optimizer=torch.optim.SGD(pck_layers.parameters(), lr=0.25, weight_decay=0.0))
